...
public class SchemaRegistryClient implements ISchemaRegistryClient {
    ...
    public SchemaRegistryClient(Map<String, ?> conf) {
        ...
        String password = configuration.getValue(Configuration.BASIC_AUTH_USERNAME.name());
    ...
    public static final class Configuration {
        ...
        public static final ConfigEntry<String> BASIC_AUTH_USERNAME =
                ConfigEntry.optional("schema.registry.client.basic.auth.username",
                        String.class,
                        "Username for basic authentication",
                        null,
                        ConfigEntry.NonEmptyStringValidator.get());
        ...
        public static final ConfigEntry<String> BASIC_AUTH_PASSWORD =
                ConfigEntry.optional("schema.registry.client.basic.auth.password",
                        String.class,
                        "Password for basic authentication",
                        null,
                        ConfigEntry.NonEmptyStringValidator.get());
